        ...
        <section className="flex-1 mx-auto w-full max-w-4xl px-4 py-8 sm:px-6 flex flex-col gap-6">
          ...
          <div className="space-y-4 flex-1 flex flex-col">
            <input
              ...
              required
              className="w-full text-3xl font-bold bg-transparent border-0 border-b border-transparent focus:border-stone-200 focus:outline-none placeholder-stone-400 pb-2 text-stone-950 transition"
            />
            <textarea
              name="content"
